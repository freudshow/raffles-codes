...
{
    public partial class TreatmentCtl : UserControl
    {
        public TreatmentCtl()
        {
            InitializeComponent();
        ...
        private void 交出处理ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < selectedlist.Count; i++)
            {
                ...
                this.dataGridView1.Rows[index].Cells["交出处理日期"].Value = datetime;
            }
            selectedlist.Clear();
            MessageBox.Show("--------完成--------");
        }
