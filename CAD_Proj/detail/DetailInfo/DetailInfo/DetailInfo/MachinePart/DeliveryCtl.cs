...
{
    public partial class DeliveryCtl : UserControl
    {
        public DeliveryCtl()
        {
            InitializeComponent();
        ...
        private void 物料发放ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (addID.ShowDialog() == DialogResult.OK)
            {
                ...
                for (int i = 0; i < selectedlist.Count; i++)
                {
                    ...
                    this.dataGridView1.Rows[index].Cells["领料人"].Value = workID;
                    this.dataGridView1.Rows[index].Cells["发放日期"].Value = datetime;
                }
                selectedlist.Clear();
                MessageBox.Show("--------完成--------");
            }
