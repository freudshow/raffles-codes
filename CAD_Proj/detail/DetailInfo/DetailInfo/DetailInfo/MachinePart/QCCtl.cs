...
{
    public partial class QCCtl : UserControl
    {
        public QCCtl()
        {
            InitializeComponent();
        ...
        private void 请求报验ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < selectedlist.Count; i++)
            {
                ...
                this.dataGridView1.Rows[index].Cells["申请报验日期"].Value = datetime;
            }
            selectedlist.Clear();
            MessageBox.Show("--------完成--------");
        }
