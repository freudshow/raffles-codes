...
{
    public partial class RevieveCtl : UserControl
    {
        public RevieveCtl()
        {
            InitializeComponent();
        ...
        private void 料场接收ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < selectedlist.Count; i++)
            {
                ...
                this.dataGridView1.Rows[index].Cells["料场接收日期"].Value = datetime;
            }
            selectedlist.Clear();
            MessageBox.Show("--------完成--------");
        }
