...
{
    public partial class AssembleCtl : UserControl
    {
        public AssembleCtl()
        {
            InitializeComponent();
        ...
        private void 装配完成ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (addID.ShowDialog() == DialogResult.OK)
            {
                ...
                for (int i = 0; i < selectedlist.Count; i++)
                {
                    ...
                    this.dataGridView1.Rows[index].Cells["装配人"].Value = workID;
                    this.dataGridView1.Rows[index].Cells["装配日期"].Value = datetime;
                }
                selectedlist.Clear();
                MessageBox.Show("--------完成--------");
            }
