<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jp_pkg_query.aspx.cs" Inherits="Package.jp_pkg_query" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>大包物资申请变更</title>
    ...
    {
        window.showModalDialog("jp_pkg_mod.aspx?id="+reqid+"&objid="+objid+"&ver="+rowversion+"",window,"status:no;dialogWidth:500px;dialogHeight:620px");
        return false;
    }
        ...
        <div >
            ...
            <table id="req_content" style="font-size: 10pt">
                <tr>
                    ...
                    <td width="180">
                        <asp:DropDownList ID="DdlProdSite" runat="server" Width="160px" OnDataBound="DdlProdSite_DataBound">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td width="120">
                        申请状态：</td>
                    <td>
                        <asp:TextBox ID="TxtReqState" runat="server" Width="250px" Enabled="False" BorderStyle="Groove">初始</asp:TextBox></td>
                    <td>
                    </td>
                    <td>
                    </td>
            ...
            <asp:Button ID="BtnQuery" runat="server" Text="查询" OnClick="BtnQuery_Click"
                CssClass="button_1" UseSubmitBehavior="False" />
            </div>
