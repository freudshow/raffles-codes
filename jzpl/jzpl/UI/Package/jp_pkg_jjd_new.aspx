<%@ Page Language="C#" AutoEventWireup="true" Codebehind="jp_pkg_jjd_new.aspx.cs"
    Inherits="Package.pkg_jjd_new" %>
...
<head runat="server">
	...
	SetGVBoxHeight("divReqData","GVReqData");
    SetGVBoxHeight("gvbox2","GVDisplayJjdLine");
    SetGVBoxHeight("gvbox3","GVJjdList");}
//	alertEle = $('popuContent'); 
//	obj = $('overLay');
//	$('BtnJoinJjd').onclick = function(){
...
//		alertEle.style.top = '100px';
		//alertEle.style.top = (document.documentElement.clientHeight - alertEle.offsetHeight)/2 + 200 + 'px';
		//alert("clientHeight:"+document.documentElement.clientHeight+"\n"+"offsetHeight:"+alertEle.offsetHeight);
		
	//}
	
	
//	$("BtnQuitPopuWin").onclick = $("BtnQuitPopuWin1").onclick = function(){
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="divCreateJjd" runat="server">
                ...
                <tr>
                    ...
                    <td style="width: 160px">
                        <asp:TextBox ID="TxtRecieveDate" name="TxtRecieveDate" runat="server" AutoPostBack="True"
                            onfocus="WdatePicker();" Width="142px"></asp:TextBox><span
            ...
            <div id="divReqData" runat="server" style="overflow-x: auto; overflow-y: none; width: 100%">
                <asp:GridView ID="GVReqData" runat="server" AutoGenerateColumns="False" OnRowDataBound="GVReqData_RowDataBound"
                    CssClass="gv" Width="1260px">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="零件规格" HeaderStyle-Width="200px">
                            <ItemTemplate>
                                <p style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 200px;
                                    margin: 0" title="<%# Server.HtmlEncode(Eval("part_spec").ToString())%>">
                                    <%# Eval("part_spec")%>
                                </p>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        <input type="button" value="x" style="height: 18px; width: 18px; font-size: 7pt;
                            padding: 0; vertical-align: middle; text-align: center" id="BtnQuitPopuWin1" onclick="close_pupudiv();" /></td>
                </tr>
            </table>
                ...
                <tr>
                    <td>
                        <asp:Button ID="BtnInsertJjd" runat="server" Text="加入交接单" OnClick="BtnInsertJjd_Click"
                            CssClass="button_2" />
                        <input id="BtnQuitPopuWin" size="" type="button" value="取消" class="button_1" style="margin-bottom: 0px" onclick="close_pupudiv();" /></td>
                </tr>
            </table>
        </div>
        <div id="divJjdDisplay" runat="server">
            ...
            <div style="overflow-x: auto; overflow-y: none; width: 100%" id="gvbox2">
                <asp:GridView ID="GVDisplayJjdLine" runat="server" AutoGenerateColumns="False" Width="1260px"
                    CssClass="gv" OnRowDataBound="GVDisplayJjdLine_RowDataBound" OnRowCommand="GVDisplayJjdLine_RowCommand">
                    <Columns>
                        <asp:TemplateField ShowHeader="False" HeaderText="删除">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImgDelete" runat="server" ImageUrl="~/images/delete_.gif" CommandName="DeleteJjdLine"
                                    OnClientClick="return window.confirm('确定要删除吗?')" CommandArgument='<%# Eval("objid") %>'
                                    ToolTip="删除" />
