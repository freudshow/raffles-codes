<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="check_person.aspx.cs" Inherits="jzpl.UI.ADMIN.check_person" %>
            ...
            <table cellpadding="0" cellspacing="0" width="600px">
                <tr>
                    <td style="width: 80px">
                        人员ID：</td>
                    <td>
                        <asp:TextBox ID="TxtID" runat="server" Width="300px"></asp:TextBox><span style="color: #ff0000">*</span></td>
                </tr>
                <tr>
                    <td style="width: 80px">
                        姓名：</td>
                    <td>
                        <span style="color: #ff0000">
                            <asp:TextBox ID="TxtName" runat="server" Width="300px"></asp:TextBox>*</span></td>
                </tr>
                <tr>
                    <td style="width: 80px">
                        IC号:：</td>
                    <td>
                        <asp:TextBox ID="TxtIC" runat="server" Width="300px"></asp:TextBox><span style="color: #ff0000">*</span></td>
                </tr>
                <tr>
                    <td style="width: 80px">
                        联系电话：</td>
                    <td>
                        <asp:TextBox ID="TxtContact" runat="server" Width="300px"></asp:TextBox><span
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GV" runat="server" AutoGenerateColumns="False" Font-Size="10pt" CssClass="gv"
                            ...
                            <Columns>
                                <asp:BoundField DataField="id" HeaderText="人员ID" ReadOnly="True">
                                    <HeaderStyle Width="80px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="person_name" HeaderText="姓名" ReadOnly="True">
