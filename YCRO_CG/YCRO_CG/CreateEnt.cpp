...
AcDbObjectId CCreateEnt::CreateHatch(AcDbObjectIdArray objIds, const ACHAR* patName, bool bAssociative)
{
	Acad::ErrorStatus es;
...
AcDbObjectId CCreateEnt::CreateDimAligned(const AcGePoint3d& pt1, const AcGePoint3d& pt2, const AcGePoint3d& ptLine, const ACHAR* dimText, AcDbObjectId dimStyle) 
{
...
AcDbObjectId CCreateEnt::CreateDimAligned(const AcGePoint3d& pt1, const AcGePoint3d& pt2, const AcGePoint3d& ptLine, const AcGeVector3d& vecOffset, const ACHAR* dimText)
{
...
AcDbObjectId CCreateEnt::CreateDimRotated(const AcGePoint3d& pt1, const AcGePoint3d& pt2, const AcGePoint3d& ptLine, double rotation, const ACHAR* dimText, AcDbObjectId dimStyle)
{
...
AcDbObjectId CCreateEnt::CreateDimRadial(const AcGePoint3d& ptCenter, const AcGePoint3d& ptChord, double leaderLength, const ACHAR* dimText, AcDbObjectId dimStyle)
{ 
